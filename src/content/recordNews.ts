...
export const RECORD_NEWS_LEAD: RecordNewsItem = {
  title: "Why I believe SANDAG’s multibillion-dollar project case is full of holes",
  url: "https://www.sandiegouniontribune.com/2025/04/23/opinion-sandags-case-for-multibillion-dollar-project-is-full-of-holes/",
  ariaLabel: "Read: Why I believe SANDAG’s multibillion-dollar project case is full of holes",
  imageUrl:
...
export const RECORD_NEWS_RAIL: RecordNewsItem[] = [
  {
    title: "Why I oppose county tax hikes",
  ...
  {
    title: "Why I pair compassion with accountability",
  ...
  {
    title: "Why I oppose the transfer tax hike",
